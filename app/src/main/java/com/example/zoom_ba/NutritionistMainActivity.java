...
public class NutritionistMainActivity extends AppCompatActivity {
    ...
    private Button Main_BTN_equipment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Main_BTN_equipment.setOnClickListener(click);
    ...
    private View.OnClickListener click = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if(view.getTag().toString().equals("workout")){
                intent = new Intent(NutritionistMainActivity.this,TrainingActivity.class);
                startActivity(intent);
            }else if(view.getTag().toString().equals("requests")){
                intent = new Intent(NutritionistMainActivity.this,RequestActivity.class);
                startActivity(intent);
            }else if(view.getTag().toString().equals("nutritionist")){
                intent = new Intent(NutritionistMainActivity.this,NutritionistActivity.class);
                startActivity(intent);
            }else if(view.getTag().toString().equals("equipment")){
                intent = new Intent(NutritionistMainActivity.this,ParmanentActivity.class);
                startActivity(intent);
            }else if(view.getTag().toString().equals("settings")){
                intent = new Intent(NutritionistMainActivity.this,SettingsActivity.class);
                startActivity(intent);
            }else if(view.getTag().toString().equals("user")){
                intent = new Intent(NutritionistMainActivity.this,UserActivity.class);
                startActivity(intent);
            }
        }
    };
    ...
    private void findViews() {
        ...
        Main_BTN_equipment = findViewById(R.id. Main_BTN_equipment);
